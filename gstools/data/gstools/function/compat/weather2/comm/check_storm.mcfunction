...
execute if entity @e[tag=gstools_worker,type=marker,scores={ticSecond=1..1}] positioned ~ -64 ~ if block ~ ~ ~ weather2:tornado_sensor[powered=false] run scoreboard players remove @s _nearSevereWeather 0
