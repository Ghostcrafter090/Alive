...
execute positioned 0 0 0 run setblock ~ ~ ~ command_block{auto:1b,Command:"execute as @e[tag=weather2_node,type=marker] at @s run weather2 summon tornado_f0"} destroy
# <node:no_compile_mode/>
