...
execute positioned ~ -64 ~ if block ~ ~ ~ weather2:tornado_sensor[powered=false] run scoreboard players remove @s _nearSevereWeather 1
execute positioned ~ -64 ~ if block ~ ~ ~ weather2:tornado_sensor[powered=true] run scoreboard players set @s _nearSevereWeather 400
