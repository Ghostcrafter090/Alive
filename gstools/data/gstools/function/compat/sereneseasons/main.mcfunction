...
execute as @e[type=marker,tag=gstools_worker] if entity @s[scores={seasonGrabberIndex=100..}] unless entity @s[scores={currentSeasonDay=1..60}] run function gstools:compat/sereneseasons/temperature/season
