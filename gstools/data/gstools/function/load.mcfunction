...
scoreboard objectives add maxCommandChainLength dummy
scoreboard objectives add maxCommandForkCount dummy
scoreboard objectives add functionCommandLimit dummy
...
scoreboard players set @e[tag=gstools_worker,type=marker] 16 16
...
scoreboard players set @e[tag=gstools_worker,type=marker] 32 32
scoreboard players set @e[tag=gstools_worker,type=marker] 21 21
scoreboard players set @e[tag=gstools_worker,type=marker] 41 41
...
scoreboard players set @e[tag=gstools_worker,type=marker] 312 312
...
scoreboard players set @e[tag=gstools_worker,type=marker] isWeather2Present 0
...
scoreboard players set @e[tag=gstools_worker,type=marker] averageTpsDesirePathsWorkerMultTen 400
scoreboard players set @e[tag=gstools_worker,type=marker] averageTpsBlockDecayWorkerMultTen 350
scoreboard players set @e[tag=gstools_worker,type=marker] averageTpsDynamicDirtWorkerMultTen 370
scoreboard players set @e[tag=gstools_worker,type=marker] averageTpsDynamicEcosystemsWorkerMultTen 360
...
scoreboard players set @e[tag=gstools_worker,type=marker] averageTpsDynamicDirt 20
scoreboard players set @e[tag=gstools_worker,type=marker] averageTpsDynamicEcosystems 20
