...
execute as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=50000..}] unless entity @s[scores={hasGivenSecondMessage=1..1}] unless score $beggerNode disableBeggerMode = @s 1 as @e[tag=alive_name_marker] run tellraw @a ["","Second Reminder: Credit where credit is due! Alive Ecosystem by ",{"click_event":{"action":"open_url","url":"https://www.youtube.com/channel/UCNVTK59xpYFQBZG9kSHMzRA"},"color":"dark_blue","hover_event":{"action":"show_text","value":[{"text":"Youtube Channel","color":"dark_blue"}]},"text":"The Satosus Project","underlined":true}]
...
execute as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=312500..}] unless entity @s[scores={hasGivenFourthMessage=1..1}] unless score $beggerNode disableBeggerMode = @s 1 as @e[tag=alive_name_marker] run tellraw @a ["","Last Reminder: Credit where credit is due! Alive Ecosystem by ",{"click_event":{"action":"open_url","url":"https://www.youtube.com/channel/UCNVTK59xpYFQBZG9kSHMzRA"},"color":"dark_blue","hover_event":{"action":"show_text","value":[{"text":"Youtube Channel","color":"dark_blue"}]},"text":"The Satosus Project","underlined":true}]
