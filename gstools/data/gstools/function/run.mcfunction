...
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=1000..}] unless entity @s[scores={hasGivenFirstMessage=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run tellraw @a ["","Credit where credit is due! Alive Mod Ecosystem by ",{"click_event":{"action":"open_url","url":"https://www.youtube.com/channel/UCNVTK59xpYFQBZG9kSHMzRA"},"color":"dark_blue","hover_event":{"action":"show_text","value":[{"text":"Youtube Channel","color":"dark_blue"}]},"text":"The Satosus Project","underlined":true}]
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=10000..}] unless entity @s[scores={hasGivenSecondMessage=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run tellraw @a ["","Second Reminder: Credit where credit is due! Alive Ecosystem by ",{"click_event":{"action":"open_url","url":"https://www.youtube.com/channel/UCNVTK59xpYFQBZG9kSHMzRA"},"color":"dark_blue","hover_event":{"action":"show_text","value":[{"text":"Youtube Channel","color":"dark_blue"}]},"text":"The Satosus Project","underlined":true}]
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=50000..}] unless entity @s[scores={hasGivenThirdMessage=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run tellraw @a ["","Second Last Reminder: Credit where credit is due! Alive Ecosystem by ",{"click_event":{"action":"open_url","url":"https://www.youtube.com/channel/UCNVTK59xpYFQBZG9kSHMzRA"},"color":"dark_blue","hover_event":{"action":"show_text","value":[{"text":"Youtube Channel","color":"dark_blue"}]},"text":"The Satosus Project","underlined":true}]
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=100000..}] unless entity @s[scores={hasGivenFourthMessage=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run tellraw @a ["","Last Reminder: Credit where credit is due! Alive Ecosystem by ",{"click_event":{"action":"open_url","url":"https://www.youtube.com/channel/UCNVTK59xpYFQBZG9kSHMzRA"},"color":"dark_blue","hover_event":{"action":"show_text","value":[{"text":"Youtube Channel","color":"dark_blue"}]},"text":"The Satosus Project","underlined":true}]

execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=1000..}] unless entity @s[scores={hasGivenFirstMessage=1..1}] run scoreboard players set @s hasGivenFirstMessage 1
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=10000..}] unless entity @s[scores={hasGivenSecondMessage=1..1}] run scoreboard players set @s hasGivenSecondMessage 1
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=50000..}] unless entity @s[scores={hasGivenThirdMessage=1..1}] run scoreboard players set @s hasGivenThirdMessage 1
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={gameTime=100000..}] unless entity @s[scores={hasGivenFourthMessage=1..1}] run scoreboard players set @s hasGivenFourthMessage 1

# Patreon Message
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={timeOfDay=..3000}] unless entity @s[scores={hasGivenDailyPatreonReminder=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run tellraw @a ["","[ ",{"color":"dark_blue","obfuscated":true,"text":"XX"},{"color":"green","text":" REMINDER"},{"color":"dark_blue","obfuscated":true,"text":" XX"},{"text":" ]\nIf you have funds to spare, and you enjoy the "},{"color":"red","text":"Alive Mod Ecosystem"},", please consider supporting us (",{"color":"dark_purple","text":"The Satosus Project"},{"text":") on patreon! Times are hard right now and every little bit helps!\n("},{"click_event":{"action":"open_url","url":"https://www.patreon.com/cw/the_satosus_project"},"color":"blue","hover_event":{"action":"show_text","contents":"https://www.patreon.com/cw/the_satosus_project","value":[{"text":""}]},"text":"Patreon Link"},{"text":")\n\nA patch mod to disable this message will eventually be available on our patreon!"}]
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] if entity @s[scores={timeOfDay=..3000}] unless entity @s[scores={hasGivenDailyPatreonReminder=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run scoreboard players set @s hasGivenDailyPatreonReminder 1
execute unless entity @a[name=!Ghostcrafter090] if entity @p as @e[tag=gstools_worker,type=marker] unless entity @s[scores={timeOfDay=..3000}] if entity @s[scores={hasGivenDailyPatreonReminder=1..1}] unless score $beggerNode disableBeggerMode = @s 1 run scoreboard players set @s hasGivenDailyPatreonReminder 0
