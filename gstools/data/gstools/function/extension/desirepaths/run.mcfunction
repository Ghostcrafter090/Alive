...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingDesirePaths=1..1,averageTpsDesirePathsWorkerMultTen=240..}] run scoreboard players remove @s averageTpsDesirePathsWorkerMultTen 20
