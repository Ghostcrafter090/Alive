...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingDesirePaths=1..1,averageTpsDesirePathsWorkerMultTen=200..}] run scoreboard players operation @s averageTpsDesirePathsWorkerMultTen -= @s 20
