...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingEnhancedSurvival=1..1,averageTpsEnhancedSurvivalWorkerMultTen=240..}] run scoreboard players remove @s averageTpsEnhancedSurvivalWorkerMultTen 20
