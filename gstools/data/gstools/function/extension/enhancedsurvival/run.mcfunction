...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingEnhancedSurvival=1..1,averageTpsEnhancedSurvivalWorkerMultTen=200..}] run scoreboard players operation @s averageTpsEnhancedSurvivalWorkerMultTen -= @s 20
