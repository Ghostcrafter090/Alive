...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingLifeAndDeath=1..1}] run scoreboard players operation @s averageTpsLifeAndDeathWorkerMultTen /= @s 2
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingLifeAndDeath=1..1}] run scoreboard players operation @s averageTpsLifeAndDeathWorkerMultTen += @s 40
