...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingLifeAndDeath=1..1,averageTpsLifeAndDeathWorkerMultTen=240..}] run scoreboard players remove @s averageTpsLifeAndDeathWorkerMultTen 20
