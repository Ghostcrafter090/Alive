...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingDynamicMonsters=1..1,averageTpsDynamicMonstersWorkerMultTen=240..}] run scoreboard players remove @s averageTpsDynamicMonstersWorkerMultTen 20
