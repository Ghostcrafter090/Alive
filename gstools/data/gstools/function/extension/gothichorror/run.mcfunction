...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingGothicHorror=1..1,averageTpsGothicHorrorWorkerMultTen=240..}] run scoreboard players remove @s averageTpsGothicHorrorWorkerMultTen 20
