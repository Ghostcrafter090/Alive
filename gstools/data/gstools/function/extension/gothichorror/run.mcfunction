...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingGothicHorror=1..1,averageTpsGothicHorrorWorkerMultTen=200..}] run scoreboard players operation @s averageTpsGothicHorrorWorkerMultTen -= @s 20
