...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingBlockDecay=1..1,averageTpsBlockDecayWorkerMultTen=240..}] run scoreboard players remove @s averageTpsBlockDecayWorkerMultTen 20
