...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingDynamicEcosystems=1..1}] run scoreboard players operation @s averageTpsDynamicEcosystemsWorkerMultTen += @s 40
