...
execute as @e[tag=gstools_worker,type=marker,scores={globalTicDesirePaths=..19}] run scoreboard players set @s doRunDesirePaths 0
...
execute as @e[tag=gstools_worker,type=marker,scores={globalTicBlockDecay=..19}] run scoreboard players set @s doRunBlockDecay 0
...
execute as @e[tag=gstools_worker,type=marker,scores={globalTicDynamicDirt=..19}] run scoreboard players set @s doRunDynamicDirt 0
...
execute as @e[tag=gstools_worker,type=marker,scores={globalTicDynamicEcosystems=..19}] run scoreboard players set @s doRunDynamicEcosystems 0
...
execute as @e[tag=gstools_worker,type=marker,scores={globalTicEnhancedSurvival=..19}] run scoreboard players set @s doRunEnhancedSurvival 0
...
execute as @e[tag=gstools_worker,type=marker,scores={globalTicLifeAndDeath=..19}] run scoreboard players set @s doRunLifeAndDeath 0
