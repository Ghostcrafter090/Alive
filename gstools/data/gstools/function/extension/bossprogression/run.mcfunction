...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingBossProgression=1..1,averageTpsBossProgressionWorkerMultTen=200..}] run scoreboard players operation @s averageTpsBossProgressionWorkerMultTen -= @s 20
