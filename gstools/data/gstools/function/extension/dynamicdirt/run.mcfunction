...
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingDynamicDirt=1..1}] run scoreboard players operation @s averageTpsDynamicDirtWorkerMultTen /= @s 2
execute as @e[type=marker,tag=gstools_worker,scores={currentlyExecutingDynamicDirt=1..1}] run scoreboard players operation @s averageTpsDynamicDirtWorkerMultTen += @s 40
