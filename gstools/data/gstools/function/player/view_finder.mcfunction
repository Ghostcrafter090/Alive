...
execute as @a at @s  as @e[type=marker,tag=gstools_rotation_finder,distance=0..20,sort=nearest,limit=1] run tp @s ^ ^ ^15
...
execute as @a[scores={viewFinderDebug=1..1}] at @s as @e[tag=gstools_view_finder,type=marker,distance=0..20,sort=nearest,limit=1] at @s run particle large_smoke ~ ~ ~ 0.1 0.1 0.1 0 10 force
execute as @a[scores={viewFinderDebug=1..1}] at @s as @e[tag=gstools_rotation_finder,type=marker,distance=0..20,sort=nearest,limit=1] at @s run particle large_smoke ~ ~ ~ 0.1 0.1 0.1 0 10 force
