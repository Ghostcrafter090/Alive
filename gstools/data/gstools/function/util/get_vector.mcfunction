...
execute store result score @s PosEntityX run data get entity @s Pos[0] 100
execute store result score @s PosEntityY run data get entity @s Pos[1] 100
execute store result score @s PosEntityZ run data get entity @s Pos[2] 100
