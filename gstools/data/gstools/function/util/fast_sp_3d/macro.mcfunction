...
execute unless predicate gstools:mostlyair at @e[type=marker,tag=fast_sp_3d_return_position,limit=1,sort=nearest] run tag @s add fast_3d_sp_loop
execute if entity @s[tag=fast_3d_sp_loop] at @e[type=marker,tag=fast_sp_3d_return_position,limit=1,sort=nearest] run tp @s ~ ~ ~
execute if entity @s[tag=fast_3d_sp_loop] at @e[type=marker,tag=fast_sp_3d_return_position,limit=1,sort=nearest] run function gstools:util/fast_sp_3d/macro