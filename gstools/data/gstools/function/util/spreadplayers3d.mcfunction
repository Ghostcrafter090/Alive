...
execute at @s run function gstools:util/is_outside
execute at @s if predicate gstools:spreadplayers_nether unless entity @s[scores={isOutside=1..1}] run tag @s remove to_spreadplayers_3d
execute at @s unless predicate gstools:spreadplayers_nether run tag @s add to_spreadplayers_3d
execute as @s if entity @s[scores={isOutside=1..1}] run tag @s add to_spreadplayers_3d
