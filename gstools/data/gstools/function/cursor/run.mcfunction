...
execute as @e[tag=gstools_chunk_worker,limit=1,sort=random] at @s store result score @s chunkLoaderCount if entity @e[tag=gstools_chunk_worker,distance=..400]
