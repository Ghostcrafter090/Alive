...
execute as @a at @s store result score @s numberOfCursors if entity @e[tag=gstools_cursor,tag=!block_decay_spawned,type=marker,distance=0..200,tag=!spread_from_self]
...
execute if entity @e[type=marker,tag=gstools_worker,scores={enableDebugMessages=1..1}] as @e[tag=chunk_loader,sort=random,limit=1] at @s unless entity @e[tag=gstools_chunk_worker,distance=..400,type=marker] run say spawned chunk_worker!
...
execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] run scoreboard players set @e[tag=gstools_worker,type=marker,limit=1] cursorInArrears 0
execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] as @e[tag=gstools_chunk_worker,type=marker] if score @s cursorTic < @e[tag=gstools_worker,type=marker,limit=1] cursorTic run scoreboard players operation @e[tag=gstools_worker,type=marker] cursorInArrears += @e[tag=gstools_worker,type=marker] cursorTic
execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] as @e[tag=gstools_chunk_worker,type=marker] if score @s cursorTic < @e[tag=gstools_worker,type=marker,limit=1] cursorTic run scoreboard players operation @e[tag=gstools_worker,type=marker] cursorInArrears -= @s cursorTic
execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] run function gstools:cursor/chunk/summon

execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] if entity @e[tag=gstools_chunk_worker,scores={numberOfUnloadedCursorsSpawned=800..800}] run schedule function gstools:cursor/chunk/loadrandom 1t

execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] as @e[tag=gstools_worker,type=marker] run scoreboard players add @s cursorTic 1
# execute as @e[tag=gstools_worker,type=marker] run scoreboard players add @s cursorTic 1

execute if entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] as @e[tag=gstools_chunk_worker] at @s run forceload add ~ ~ ~ ~
execute unless entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] as @e[tag=gstools_chunk_worker] at @s unless entity @e[tag=gstools_worker,distance=..16] run forceload remove ~ ~ ~ ~
execute unless entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] run forceload remove all
execute unless entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] run forceload add 0 0
execute unless entity @e[type=marker,tag=gstools_worker,scores={averageTps=16..}] unless entity @e[type=marker,tag=gstools_worker,scores={chunk_disableDynamicChunkLoading=1..}] if entity @e[tag=gstools_worker,type=marker,scores={seasonGrabberIndex=0..99}] run forceload add 5999938 0 5999938 0
