...
execute as @e[tag=gstools_vertical_cursor] if entity @s[tag=notmoved] store result entity @s Pos[1] double 1 run scoreboard players get @e[type=marker,tag=gstools_cursor,limit=1,sort=nearest] verticalCursorWorker
