...
$scoreboard players set #TimeLib.Temp TimeLib $(Hours)
    ...
    execute if score #TimeLib TimeLib.Hour matches 10.. run data modify storage timelib_:daytime Hour set string storage timelib_:daytime Hour 0 2
    execute if score #TimeLib TimeLib.Hour matches 9 run data modify storage timelib_:daytime Hour set value "09"
    execute if score #TimeLib TimeLib.Hour matches 8 run data modify storage timelib_:daytime Hour set value "08"
    execute if score #TimeLib TimeLib.Hour matches 7 run data modify storage timelib_:daytime Hour set value "07"
    execute if score #TimeLib TimeLib.Hour matches 6 run data modify storage timelib_:daytime Hour set value "06"
    execute if score #TimeLib TimeLib.Hour matches 5 run data modify storage timelib_:daytime Hour set value "05"
    execute if score #TimeLib TimeLib.Hour matches 4 run data modify storage timelib_:daytime Hour set value "04"
    execute if score #TimeLib TimeLib.Hour matches 3 run data modify storage timelib_:daytime Hour set value "03"
    execute if score #TimeLib TimeLib.Hour matches 2 run data modify storage timelib_:daytime Hour set value "02"
    execute if score #TimeLib TimeLib.Hour matches 1 run data modify storage timelib_:daytime Hour set value "01"
    execute if score #TimeLib TimeLib.Hour matches 0 run data modify storage timelib_:daytime Hour set value "00"
...
function timelib_:zprivate/settings/select
