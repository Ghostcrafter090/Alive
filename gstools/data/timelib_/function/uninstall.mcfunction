...
data remove storage timelib_:zprivate Base64
data remove storage timelib_:zprivate Days
data remove storage timelib_:zprivate CommandBlock
data remove storage timelib_:date WeekDay
data remove storage timelib_:date Month
data remove storage timelib_:date Day
data remove storage timelib_:date Year
data remove storage timelib_:daytime Hour
data remove storage timelib_:daytime Minute
data remove storage timelib_:daytime Second
data remove storage timelib_:output WeekDay
data remove storage timelib_:output Month
data remove storage timelib_:output Day
data remove storage timelib_:output Year
data remove storage timelib_:output Hour
data remove storage timelib_:output Minute
data remove storage timelib_:output Second
...
schedule clear timelib_:zprivate/tick
