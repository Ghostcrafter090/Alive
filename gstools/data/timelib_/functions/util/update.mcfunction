...
schedule clear timelib_:zprivate/update/setup/tick_loop
...
execute as @a[limit=1] store success score #TimeLib.PlayerHead TimeLib run loot replace block 29999983 0 29999983 container.0 loot timelib_:fill_player_head
...
schedule function timelib_:zprivate/update/setup/start_checks 2t