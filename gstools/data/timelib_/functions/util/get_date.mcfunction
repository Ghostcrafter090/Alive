...
execute store result storage timelib_:zprivate calc.Days short 1 run scoreboard players operation #TimeLib.Output TimeLib.Day %= #c1461 Constant
...
function timelib_:zprivate/get_date/main with storage timelib_:zprivate calc
execute store result score #TimeLib.Output TimeLib.Day run data get storage timelib_:zprivate calc.Date.Day
execute store result score #TimeLib.Output TimeLib.Month run data get storage timelib_:zprivate calc.Date.Month
execute store result score #TimeLib.Output TimeLib.Year run data get storage timelib_:zprivate calc.Date.Year
