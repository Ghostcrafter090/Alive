...
data remove storage timelib_:zprivate days_list
data remove storage timelib_:zprivate b64
data remove storage timelib_:zprivate cmd_block
data remove storage timelib_:zprivate calc

#Stop Schedule Loops
schedule clear timelib_:zprivate/timer_1s
schedule clear timelib_:zprivate/timer_1min
schedule clear timelib_:zprivate/timer_1h
schedule clear timelib_:zprivate/timer_1d

schedule clear timelib_:zprivate/singleplayer/pause/detect
schedule clear timelib_:zprivate/singleplayer/timer_1s

schedule clear timelib_:zprivate/daylight_savings_time_checks/timer_1h