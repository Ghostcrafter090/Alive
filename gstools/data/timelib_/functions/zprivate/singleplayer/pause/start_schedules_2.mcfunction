...
execute store result storage timelib_:zprivate calc.Result.NextSecondStart byte 1 run scoreboard players get #TimeLib.NextSecondStart TimeLib.Tick
...
execute store result storage timelib_:zprivate calc.Result.NextMinuteStart short 1 run scoreboard players operation #TimeLib.NextMinuteStart TimeLib.Second -= #TimeLib.Calc TimeLib
...
execute store result storage timelib_:zprivate calc.Result.NextHourStart int 1 run scoreboard players operation #TimeLib.NextHourStart TimeLib.Second -= #TimeLib.Calc TimeLib
...
execute store result storage timelib_:zprivate calc.Result.NextDayStart int 1 run scoreboard players operation #TimeLib.NextDayStart TimeLib.Second -= #TimeLib.Calc TimeLib

function timelib_:zprivate/singleplayer/pause/start_schedules_3 with storage timelib_:zprivate calc.Result