...
function timelib_:zprivate/singleplayer/pause/start_schedules

execute if score #TimeLib TimeLib.Day matches ..28 run return 0

execute if score #TimeLib TimeLib.Month matches 1 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 3 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 4 if score #TimeLib TimeLib.Day matches 31 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 5 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 6 if score #TimeLib TimeLib.Day matches 31 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 7 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 8 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 9 if score #TimeLib TimeLib.Day matches 31 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 10 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 11 if score #TimeLib TimeLib.Day matches 31 run return run function timelib_:zprivate/advance_month
execute if score #TimeLib TimeLib.Month matches 12 if score #TimeLib TimeLib.Day matches 32 run return run function timelib_:zprivate/advance_year
...
execute if score #TimeLib.Check TimeLib matches 0 run return run function timelib_:zprivate/advance_month
