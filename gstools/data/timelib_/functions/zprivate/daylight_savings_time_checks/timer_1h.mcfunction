...
schedule function timelib_:zprivate/daylight_savings_time_checks/check 2t

schedule function timelib_:zprivate/daylight_savings_time_checks/timer_1h 3600s