...
data modify storage timelib_:zprivate cmd_block.Time.Hour set string block 29999983 1 29999983 LastOutput 10 12
function timelib_:zprivate/daylight_savings_time_checks/set_cmd_block_time with storage timelib_:zprivate cmd_block.Time
...
scoreboard players operation #TimeLib.Calc TimeLib = #TimeLib TimeLib.Hour
scoreboard players operation #TimeLib.Calc TimeLib -= #TimeLib.CommandBlock TimeLib.Hour
execute if score #TimeLib.Calc TimeLib matches 12.. run function timelib_:zprivate/timer_1d
...
execute store result storage timelib_:zprivate calc.Result.NextDayStart int 1 run scoreboard players operation #TimeLib.NextDayStart TimeLib.Second -= #TimeLib.CommandBlock TimeLib.Hour
function timelib_:zprivate/daylight_savings_time_checks/start_schedules with storage timelib_:zprivate calc.Result