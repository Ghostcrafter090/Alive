#Get Unix Timestamp
data modify storage timelib_:zprivate b64.data set from block 29999983 0 29999983 Items[0].tag.SkullOwner.Properties.textures[0].Value
data modify storage timelib_:zprivate b64.input.0 set string storage timelib_:zprivate b64.data 24 28
data modify storage timelib_:zprivate b64.input.1 set string storage timelib_:zprivate b64.data 28 32
data modify storage timelib_:zprivate b64.input.2 set string storage timelib_:zprivate b64.data 32 36
data modify storage timelib_:zprivate b64.input.3 set string storage timelib_:zprivate b64.data 36 40
function timelib_:zprivate/update/b64/decode with storage timelib_:zprivate b64.input
...
function timelib_:util/get_date
