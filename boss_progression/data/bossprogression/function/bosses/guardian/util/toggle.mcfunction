...
tag @a remove hide_guardian_fog
...
execute as @e[type=elder_guardian,sort=random,limit=1] at @s as @a[distance=0..30,nbt={equipment:{head:{id:"minecraft:turtle_helmet",count:1,components:{"minecraft:enchantments":{"minecraft:flame":1}}}}}] run tag @s add hide_guardian_fog
...
execute as @e[type=elder_guardian,sort=random,limit=1] at @s as @a[distance=0..30,nbt={Inventory:[{Slot: 103b, components: {"minecraft:trim": {material: "minecraft:gold", pattern: "minecraft:coast"}, "minecraft:enchantments": {levels: {"minecraft:binding_curse": 1, "minecraft:respiration": 1, "minecraft:aqua_affinity": 1, "minecraft:flame": 1}}}, id: "minecraft:turtle_helmet"}]}] run tag @s add hide_guardian_fog
