...
execute as @e[type=elder_guardian,sort=random,limit=1,tag=guardian_disable] at @s if entity @a[distance=0..30,nbt={SelectedItem:{id:"minecraft:totem_of_undying",components:{"minecraft:enchantment_glint_override":1b}}}] run summon lightning_bolt ~ ~30 ~
