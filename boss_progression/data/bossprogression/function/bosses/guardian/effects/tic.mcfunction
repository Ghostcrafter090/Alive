...
execute as @e[type=elder_guardian] at @s run function gstools:compat/weather2/comm/check_storm

function bossprogression:bosses/guardian/effects/compat/burnt_fog