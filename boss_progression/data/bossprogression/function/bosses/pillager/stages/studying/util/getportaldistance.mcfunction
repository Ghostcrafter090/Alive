...
execute unless entity @p[scores={ruinedPortalDistanceType=0..2}] run function bossprogression:bosses/pillager/stages/studying/util/getportaldistance/getclosest
