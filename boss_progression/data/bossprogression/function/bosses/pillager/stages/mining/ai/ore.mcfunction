...
execute as @e[tag=mining_pillager,tag=pillager_found_ore] if entity @s[scores={pillagerMiningDirection=1..1}] at @s if block ~-10 ~ ~ #gstools:air run summon tnt ~ ~ ~ {Tags:['pillager_tnt']}
...
execute as @e[tag=mining_pillager,tag=pillager_found_ore] if entity @s[scores={pillagerMiningDirection=2..2}] at @s if block ~10 ~ ~ #gstools:air run summon tnt ~ ~ ~ {Tags:['pillager_tnt']}
...
execute as @e[tag=mining_pillager,tag=pillager_found_ore] if entity @s[scores={pillagerMiningDirection=3..3}] at @s if block ~ ~ ~-10 #gstools:air run summon tnt ~ ~ ~ {Tags:['pillager_tnt']}
...
execute as @e[tag=mining_pillager,tag=pillager_found_ore] if entity @s[scores={pillagerMiningDirection=4..4}] at @s if block ~ ~ ~10 #gstools:air run summon tnt ~ ~ ~ {Tags:['pillager_tnt']}
