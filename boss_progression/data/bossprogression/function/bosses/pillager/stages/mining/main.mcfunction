...
execute as @e[type=marker,tag=pillager_mining_outpost_component,tag=not_setup,sort=random,limit=1] at @s if entity @s[tag=do_setup,scores={random100=61..81}] run place template minecraft:pillager_outpost/feature_cage1
execute as @e[type=marker,tag=pillager_mining_outpost_component,tag=not_setup,sort=random,limit=1] at @s unless entity @e[tag=gstools_worker,type=marker,scores={pillagerStage=3..}] if entity @s[tag=do_setup,scores={random100=82..100}] run place template minecraft:pillager_outpost/feature_cage2
execute as @e[type=marker,tag=pillager_mining_outpost_component,tag=not_setup,sort=random,limit=1] at @s if entity @e[tag=gstools_worker,type=marker,scores={pillagerStage=3..}] if entity @s[tag=do_setup,scores={random100=82..100}] run summon marker ~ ~ ~ {Tags:['attack_portal_node','pillager_made']}
