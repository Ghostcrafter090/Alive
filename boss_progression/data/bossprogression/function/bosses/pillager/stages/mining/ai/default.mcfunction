...
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=5..}] at @s unless block ~ ~1 ~1 #gstools:air if block ~ ~1 ~ #gstools:air run fill ~ ~1 ~ ~ ~1 ~ ladder[facing=north] destroy
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={lightLevel=..0}] at @s unless block ~ ~-1 ~ #gstools:air if block ~1 ~1 ~ #gstools:air if block ~-1 ~1 ~ #gstools:air if block ~ ~1 ~1 #gstools:air if block ~ ~1 ~-1 #gstools:air run fill ~ ~ ~ ~ ~ ~ redstone_torch replace #gstools:air
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={lightLevel=..0}] at @s unless block ~1 ~1 ~ #gstools:air run fill ~ ~1 ~ ~ ~1 ~ redstone_wall_torch[facing=west] replace #gstools:air
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={lightLevel=..0}] at @s unless block ~-1 ~1 ~ #gstools:air run fill ~ ~1 ~ ~ ~1 ~ redstone_wall_torch[facing=east] replace #gstools:air
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={lightLevel=..0}] at @s unless block ~ ~1 ~1 #gstools:air run fill ~ ~1 ~ ~ ~1 ~ redstone_wall_torch[facing=north] replace #gstools:air
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={lightLevel=..0}] at @s unless block ~ ~1 ~-1 #gstools:air run fill ~ ~1 ~ ~ ~1 ~ redstone_wall_torch[facing=south] replace #gstools:air
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={lightLevel=..0}] at @s run function gstools:util/light_level
execute as @e[tag=mining_pillager,type=pillager] if entity @s[tag=make_patrol] at @s run data modify entity @s patrol_target set from entity @e[tag=mining_pillager,type=pillager,distance=20..,sort=nearest,limit=1] Pos
execute as @e[tag=mining_pillager,type=pillager] if entity @s[tag=make_patrol] at @s run data merge entity @s {Patrolling:1b,CanJoinRaid:1b,PatrolLeader:1b}
execute as @e[tag=mining_pillager,type=pillager] if entity @s[tag=make_patrol] at @s run tag @s remove make_patrol

execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=1..}] at @s if entity @a[distance=0..20,gamemode=survival] run scoreboard players set @s pillagerMiningDirection 0
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=1..}] at @s if entity @e[tag=walkable,distance=1..8,type=!player] run damage @s 0.0001 mob_attack by @e[tag=!tile,type=!pillager,sort=nearest,distance=1..20,limit=1,type=!player] from @e[tag=!tile,type=!pillager,sort=nearest,distance=1..20,limit=1,type=!player]
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=1..}] at @s if entity @e[tag=walkable,distance=1..8,type=!player] run scoreboard players set @s pillagerMiningDirection 0
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=1..4}] at @s if predicate gstools:sky run scoreboard players set @s pillagerMiningDirection 0
...
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=1..}] at @s if entity @s[scores={pillagerTakingDamage=1..}] run effect give @s resistance 5 5 true
execute as @e[tag=mining_pillager,type=pillager] if entity @s[scores={pillagerMiningDirection=1..}] at @s if entity @s[scores={pillagerTakingDamage=1..}] run scoreboard players set @s pillagerMiningDirection 0
