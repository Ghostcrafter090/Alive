...
execute as @e[type=wither,scores={currentWitherSizeAttribute=101..150}] at @s as @e[type=skeleton,distance=..20] run scoreboard players add @s skeletonWitherConversionTime 2
execute as @e[type=wither,scores={currentWitherSizeAttribute=151..200}] at @s as @e[type=skeleton,distance=..30] run scoreboard players add @s skeletonWitherConversionTime 3
execute as @e[type=wither,scores={currentWitherSizeAttribute=201..250}] at @s as @e[type=skeleton,distance=..40] run scoreboard players add @s skeletonWitherConversionTime 4
execute as @e[type=wither,scores={currentWitherSizeAttribute=251..300}] at @s as @e[type=skeleton,distance=..50] run scoreboard players add @s skeletonWitherConversionTime 5
execute as @e[type=wither,scores={currentWitherSizeAttribute=301..350}] at @s as @e[type=skeleton,distance=..60] run scoreboard players add @s skeletonWitherConversionTime 6
execute as @e[type=wither,scores={currentWitherSizeAttribute=351..400}] at @s as @e[type=skeleton,distance=..70] run scoreboard players add @s skeletonWitherConversionTime 7
execute as @e[type=wither,scores={currentWitherSizeAttribute=400..}] at @s as @e[type=skeleton,distance=..80] run scoreboard players add @s skeletonWitherConversionTime 8
