...
execute as @e[type=marker,tag=attack_portal_node,tag=delete_portal,scores={attackPortalDeleteTic=100..}] at @s run summon fireball ~1.5 ~10 ~ {ExplosionPower:5,Motion:[0,-5,0]}
