...
execute as @e[type=marker,tag=attack_portal_node,tag=delete_portal,scores={attackPortalDeleteTic=..300}] if entity @s[scores={random100=..50}] run playsound minecraft:ambient.warped_forest.mood master @a ~ ~ ~ 1
