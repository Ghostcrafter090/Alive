...
execute unless entity @e[tag=gstools_worker,type=marker,scores={witherHasBeenKilled=1..1}] as @e[tag=gstools_worker,type=marker,scores={enchantedWitherRoseHasBeenSpawned=1..1},tag=!current_wither_temperature_add] if entity @s[scores={currentDaytimeNetherTicker=..1000}] if entity @e[tag=gstools_worker,scores={isSereneSeasonsPresent=1..1}] if entity @e[tag=gstools_worker,scores={currentSeasonDayOld=16..30}] run scoreboard players add @s currentTemperatureWitherModif 1
execute unless entity @e[tag=gstools_worker,type=marker,scores={witherHasBeenKilled=1..1}] as @e[tag=gstools_worker,type=marker,scores={enchantedWitherRoseHasBeenSpawned=1..1},tag=!current_wither_temperature_add] if entity @s[scores={currentDaytimeNetherTicker=..1000}] unless entity @e[tag=gstools_worker,scores={isSereneSeasonsPresent=1..1}] run scoreboard players add @s currentTemperatureWitherModif 1
