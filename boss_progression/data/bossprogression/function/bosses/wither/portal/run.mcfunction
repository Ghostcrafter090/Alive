...
execute as @e[tag=attack_portal_node,type=marker,tag=portal_generated,limit=1,sort=random,scores={attackPortalSpawnTic=300..},tag=pillager_made] if entity @s[scores={random100=0..20}] if entity @e[tag=gstools_worker,type=marker,limit=1,scores={numberOfOverworldNetherMobs=..165}] at @s run summon piglin ~1 ~1 ~2
execute as @e[tag=attack_portal_node,type=marker,tag=portal_generated,limit=1,sort=random,scores={attackPortalSpawnTic=300..},tag=pillager_made] if entity @s[scores={random100=20..30}] if entity @e[tag=gstools_worker,type=marker,limit=1,scores={numberOfOverworldNetherMobs=..165}] at @s run summon hoglin ~1 ~1 ~2
execute as @e[tag=attack_portal_node,type=marker,tag=portal_generated,limit=1,sort=random,scores={attackPortalSpawnTic=300..},tag=pillager_made] if entity @s[scores={random100=30..35}] if entity @e[tag=gstools_worker,type=marker,limit=1,scores={numberOfOverworldNetherMobs=..165}] at @s run summon blaze ~1 ~1 ~2
