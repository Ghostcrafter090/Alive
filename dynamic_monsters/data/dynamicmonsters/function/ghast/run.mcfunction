...
execute if entity @s[scores={random1000=..5}] as @s at @s run damage @s 0.0001 minecraft:mob_attack by @e[tag=!tile,sort=nearest,distance=10..,limit=1] from @e[tag=!tile,sort=nearest,distance=1..,limit=1]
