...
execute as @e[type=magma_cube,limit=10,sort=random] if entity @s[scores={magmaCubeUpdateTic=100..}] store result entity @s Size int 1 run scoreboard players get @s magmaCubeSize
execute as @e[type=magma_cube,limit=10,sort=random] if entity @s[scores={magmaCubeUpdateTic=100..}] run scoreboard players set @s magmaCubeUpdateTic 0
execute as @e[type=magma_cube,limit=10,sort=random] at @s unless block ~ ~ ~ lava run scoreboard players add @s magmaCubeSizeNegationWorker 1
execute as @e[type=magma_cube,limit=10,sort=random] if entity @s[scores={magmaCubeSizeNegationWorker=1000..}] run scoreboard players remove @s magmaCubeSize 1
execute as @e[type=magma_cube,limit=10,sort=random] if entity @s[scores={magmaCubeSizeNegationWorker=1000..}] store result entity @s Size int 1 run scoreboard players get @s magmaCubeSize
execute as @e[type=magma_cube,limit=10,sort=random] if entity @s[scores={magmaCubeSizeNegationWorker=1000..}] run scoreboard players set @s magmaCubeSizeNegationWorker 0
execute as @e[type=magma_cube,limit=10,sort=random] at @s if block ~ ~-1 ~ snow run scoreboard players add @s magmaCubeSizeNegationWorker 5
execute as @e[type=magma_cube,limit=10,sort=random] at @s if block ~ ~-1 ~ snow_block run scoreboard players add @s magmaCubeSizeNegationWorker 5
execute as @e[type=magma_cube,limit=10,sort=random] at @s if block ~ ~-1 ~ #minecraft:ice run scoreboard players add @s magmaCubeSizeNegationWorker 8
execute as @e[type=magma_cube,limit=10,sort=random] at @s if block ~ ~-1 ~ #minecraft:ice run effect give @s slowness 1 0
