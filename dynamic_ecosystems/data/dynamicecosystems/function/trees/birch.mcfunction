...
# Main
execute as @e[tag=gstools_cursor,type=marker] at @s unless entity @e[tag=is_human,distance=0..30] if block ~ ~-2 ~ birch_leaves positioned ~ ~-7 ~ run function gstools:compat/sereneseasons/temperature
execute as @e[tag=gstools_cursor,type=marker] at @s unless entity @e[tag=is_human,distance=0..30] if block ~ ~-2 ~ birch_leaves if entity @s[scores={currentTemperature=10..25}] run summon marker ~ ~ ~ {Tags:['birch_tree_worker']}

execute as @e[tag=birch_tree_worker,type=marker] unless entity @s[tag=birch_tree_locating] at @s run summon marker ~ ~ ~ {Tags:['birch_tree_cursor','tree_cursor']}
execute as @e[tag=birch_tree_worker,type=marker] unless entity @s[tag=birch_tree_locating] at @s run tag @s add birch_tree_locating
...
execute as @e[tag=birch_tree_worker,type=marker] if entity @s[tag=birch_tree_locating] as @e[tag=birch_tree_cursor,sort=nearest,limit=1] at @s if block ~ ~-1 ~ #minecraft:flowers run scoreboard players add @s treeSpawnThresholdWorker 10
...
execute as @e[tag=birch_tree_worker,type=marker] if entity @s[tag=birch_tree_locating] as @e[tag=birch_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run fill ~ ~-1 ~ ~ ~-1 ~ birch_sapling replace #minecraft:flowers
execute as @e[tag=birch_tree_worker,type=marker] if entity @s[tag=birch_tree_locating] as @e[tag=birch_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run tag @s add birch_tree_cursor_to_kill
...
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ birch_sapling run fill ~ ~ ~ ~ ~ ~ air replace
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ birch_sapling run place feature birch ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ birch_sapling run fill ~1 ~ ~ ~1 ~ ~ air replace birch_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ birch_sapling run fill ~ ~ ~ ~ ~ ~ air replace
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ birch_sapling run place feature birch ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ birch_sapling run fill ~-1 ~ ~ ~-1 ~ ~ air replace birch_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=..500}] as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 birch_sapling run fill ~ ~ ~ ~ ~ ~ air replace
...
execute if entity @e[tag=gstools_worker,scores={random1000=501..}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ birch_sapling run place feature birch_tall ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=501..}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ birch_sapling run fill ~1 ~ ~ ~1 ~ ~ air replace birch_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=501..}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ birch_sapling run place feature birch_tall ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=501..}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ birch_sapling run fill ~-1 ~ ~ ~-1 ~ ~ air replace birch_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=501..}] as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 birch_sapling run place feature birch_tall ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=501..}] as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 birch_sapling run fill ~ ~ ~1 ~ ~ ~1 air replace birch_sapling
