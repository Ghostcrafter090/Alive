...
# Main
execute as @e[tag=gstools_cursor,type=marker] at @s if entity @e[tag=is_human,distance=0..30] if block ~ ~-2 ~ spruce_leaves run summon marker ~ ~ ~ {Tags:['spruce_tree_worker']}
