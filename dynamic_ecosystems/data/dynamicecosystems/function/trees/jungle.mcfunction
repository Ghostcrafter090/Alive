...
# Main
execute as @e[tag=gstools_cursor,type=marker] at @s unless entity @e[tag=is_human,distance=0..30] if block ~ ~-2 ~ jungle_leaves positioned ~ ~-9 ~ run function gstools:compat/sereneseasons/temperature
execute as @e[tag=gstools_cursor,type=marker] at @s unless entity @e[tag=is_human,distance=0..30] if block ~ ~-2 ~ jungle_leaves if entity @s[scores={currentTemperature=18..30}] run summon marker ~ ~ ~ {Tags:['jungle_tree_worker']}

execute as @e[tag=jungle_tree_worker,type=marker] unless entity @s[tag=jungle_tree_locating] at @s run summon marker ~ ~ ~ {Tags:['jungle_tree_cursor','tree_cursor']}
execute as @e[tag=jungle_tree_worker,type=marker] unless entity @s[tag=jungle_tree_locating] at @s run tag @s add jungle_tree_locating
...
execute as @e[tag=jungle_tree_worker,type=marker] if entity @s[tag=jungle_tree_locating] as @e[tag=jungle_tree_cursor,sort=nearest,limit=1] at @s if block ~ ~-1 ~ #minecraft:dirt run scoreboard players add @s treeSpawnThresholdWorker 10
execute as @e[tag=jungle_tree_worker,type=marker] if entity @s[tag=jungle_tree_locating] as @e[tag=jungle_tree_cursor,sort=nearest,limit=1] at @s if block ~ ~-1 ~ #minecraft:dirt run scoreboard players add @s treeSpawnThresholdWorker 10
...
execute as @e[tag=jungle_tree_cursor,type=marker] run scoreboard players add @s treeCursorAliveTime 1
...
execute as @e[tag=jungle_tree_worker,type=marker] if entity @s[tag=jungle_tree_locating] as @e[tag=jungle_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run fill ~ ~-1 ~ ~ ~-1 ~ jungle_sapling replace #minecraft:flowers
execute as @e[tag=jungle_tree_worker,type=marker] if entity @s[tag=jungle_tree_locating] as @e[tag=jungle_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run tag @s add jungle_tree_cursor_to_kill
...
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ jungle_sapling run fill ~ ~ ~ ~ ~ ~ air replace
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ jungle_sapling run place feature jungle_tree ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ jungle_sapling run fill ~1 ~ ~ ~1 ~ ~ air replace jungle_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ jungle_sapling run fill ~ ~ ~ ~ ~ ~ air replace
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ jungle_sapling run place feature jungle_tree ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ jungle_sapling run fill ~-1 ~ ~ ~-1 ~ ~ air replace jungle_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=..900}] as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 jungle_sapling run fill ~ ~ ~ ~ ~ ~ air replace
...
execute if entity @e[tag=gstools_worker,scores={random1000=901..}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ jungle_sapling run place feature mega_jungle_tree ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=901..}] as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ jungle_sapling run fill ~1 ~ ~ ~1 ~ ~ air replace jungle_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=901..}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ jungle_sapling run place feature mega_jungle_tree ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=901..}] as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ jungle_sapling run fill ~-1 ~ ~ ~-1 ~ ~ air replace jungle_sapling
execute if entity @e[tag=gstools_worker,scores={random1000=901..}] as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 jungle_sapling run place feature mega_jungle_tree ~ ~ ~
execute if entity @e[tag=gstools_worker,scores={random1000=901..}] as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 jungle_sapling run fill ~ ~ ~1 ~ ~ ~1 air replace jungle_sapling
