...
execute as @e[tag=oak_tree_worker,type=marker] if entity @s[tag=oak_tree_locating] as @e[tag=oak_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:dirt run say Spawned Oak Tree! [standard]
...
execute as @e[tag=oak_tree_worker,type=marker] if entity @s[tag=oak_tree_locating] as @e[tag=oak_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run say Spawned Oak Tree! [flower]
