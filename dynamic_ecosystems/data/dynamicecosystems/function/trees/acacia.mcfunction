...
execute as @e[tag=acacia_tree_worker,type=marker] unless entity @s[tag=acacia_tree_locating] at @s run summon marker ~ ~ ~ {Tags:['acacia_tree_cursor','tree_cursor']}
execute as @e[tag=acacia_tree_worker,type=marker] unless entity @s[tag=acacia_tree_locating] at @s run tag @s add acacia_tree_locating
...
execute as @e[tag=acacia_tree_worker,type=marker] if entity @s[tag=acacia_tree_locating] as @e[tag=acacia_tree_cursor,sort=nearest,limit=1] at @s if block ~ ~-1 ~ #minecraft:flowers run scoreboard players add @s treeSpawnThresholdWorker 10
...
execute as @e[tag=acacia_tree_worker,type=marker] if entity @s[tag=acacia_tree_locating] as @e[tag=acacia_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run fill ~ ~-1 ~ ~ ~-1 ~ acacia_sapling replace #minecraft:flowers
execute as @e[tag=acacia_tree_worker,type=marker] if entity @s[tag=acacia_tree_locating] as @e[tag=acacia_tree_cursor,sort=nearest,limit=1] if score @s treeWorkerAliveTime < @s treeSpawnThresholdWorker at @s if block ~ ~-1 ~ #minecraft:flowers run tag @s add acacia_tree_cursor_to_kill
...
execute as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ acacia_sapling run fill ~ ~ ~ ~ ~ ~ air replace
execute as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ acacia_sapling run place feature acacia ~ ~ ~
execute as @e[tag=gstools_cursor] at @s if block ~1 ~ ~ acacia_sapling run fill ~1 ~ ~ ~1 ~ ~ air replace acacia_sapling
execute as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ acacia_sapling run fill ~ ~ ~ ~ ~ ~ air replace
execute as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ acacia_sapling run place feature acacia ~ ~ ~
execute as @e[tag=gstools_cursor] at @s if block ~-1 ~ ~ acacia_sapling run fill ~-1 ~ ~ ~-1 ~ ~ air replace acacia_sapling
execute as @e[tag=gstools_cursor] at @s if block ~ ~ ~1 acacia_sapling run fill ~ ~ ~ ~ ~ ~ air replace
