...
# Main
execute as @e[tag=is_human,type=!player] unless entity @e[tag=gothic_horror_cemetary_spawn,type=marker,distance=0..100] run summon marker ~ ~ ~ {Tags:['gothic_horror_cemetary_spawn']}
