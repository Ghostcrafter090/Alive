...
execute as @e[type=marker,tag=gstools_worker,scores={gothicMonsterRemovalTic=40..}] if score @s numberOfUndeadMonsters > @s 20 as @e[type=#minecraft:undead,limit=1,sort=random] run function gstools:horror/getindex
execute as @e[type=marker,tag=gstools_worker,scores={gothicMonsterRemovalTic=40..}] if score @s numberOfUndeadMonsters > @s 20 as @e[type=#minecraft:undead,limit=1,sort=random] run scoreboard players add @s horrorIndex 35
execute as @e[type=marker,tag=gstools_worker,scores={gothicMonsterRemovalTic=40..}] if score @s numberOfUndeadMonsters > @s 20 as @e[type=#minecraft:undead,limit=1,sort=random] if score @s horrorIndex < @e[type=marker,tag=gstools_worker,limit=1] numberOfUndeadMonsters run kill @s
execute as @e[type=marker,tag=gstools_worker,scores={gothicMonsterRemovalTic=40..}] if score @s numberOfNetherMonsters > @s 20 as @e[type=#minecraft:undead,limit=1,sort=random] if score @s horrorIndex < @e[type=marker,tag=gstools_worker,limit=1] numberOfNetherMonsters run kill @s
execute as @e[type=marker,tag=gstools_worker,scores={gothicMonsterRemovalTic=40..}] run scoreboard players set @s gothicMonsterRemovalTic 0
