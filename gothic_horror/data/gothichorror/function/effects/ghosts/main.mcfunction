...
execute as @e[type=snowball,tag=gothic_ghost_snowball_thrown,tag=!sound_played] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=0..1] run damage @e[tag=is_alive,sort=nearest,limit=1,distance=0..1] 0.1 mob_projectile by @s from @s
