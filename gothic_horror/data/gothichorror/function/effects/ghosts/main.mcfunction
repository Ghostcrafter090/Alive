...
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] store result entity @s Motion[0] double 100 run scoreboard players get @s vectorX
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] store result entity @s Motion[0] double 100 run scoreboard players get @s vectorY
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] store result entity @s Motion[0] double 100 run scoreboard players get @s vectorZ
