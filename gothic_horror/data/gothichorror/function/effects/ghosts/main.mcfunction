...
# Visual
execute as @e[tag=gstools_view_finder,type=marker] as @e[tag=gothic_ghost,distance=0..20] run effect clear @s glowing
execute as @e[tag=gstools_view_finder,type=marker] as @e[tag=gothic_ghost,distance=20..] run effect give @s glowing infinite 0 true
