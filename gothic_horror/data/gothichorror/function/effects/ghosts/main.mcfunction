...
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s facing entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] eyes positioned ~ ~1 ~ run summon egg ^ ^ ^1 {Motion:[-1.0,0.0,0.0],Item:{id:"minecraft:stone",Count:1b},Tags:['gothic_ghost_egg_thrown']}
...
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] if score @s vectorScale < @s vectorX run scoreboard players operation @s vectorScale = @s vectorX
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] if score @s vectorScale < @s vectorY run scoreboard players operation @s vectorScale = @s vectorY
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] if score @s vectorScale < @s vectorZ run scoreboard players operation @s vectorScale = @s vectorZ

execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorX *= @e[type=marker,tag=gstools_worker] 100
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorY *= @e[type=marker,tag=gstools_worker] 100
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorZ *= @e[type=marker,tag=gstools_worker] 100

execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorX /= @s vectorScale
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorY /= @s vectorScale
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorZ /= @s vectorScale


execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run data merge storage minecraft:gothichorror {MotionChange:[0.0d,0.0d,0.0d]}

execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] store result storage minecraft:gothichorror MotionChange[0] double 0.01 run scoreboard players get @s vectorX
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] store result storage minecraft:gothichorror MotionChange[1] double 0.01 run scoreboard players get @s vectorY
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] store result storage minecraft:gothichorror MotionChange[2] double 0.01 run scoreboard players get @s vectorZ

execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] run data modify entity @s Motion set from storage minecraft:gothichorror MotionChange

execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1] at @s run playsound minecraft:entity.phantom.flap block @a ~ ~ ~ 1 2

execute as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1,tag=!sound_played] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=0..1] run playsound minecraft:block.stone.break block @a ~ ~ ~ 1 2
execute as @e[type=egg,tag=gothic_ghost_egg_thrown,sort=nearest,limit=1,tag=!sound_played] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=0..1] run tag @s add sound_played
