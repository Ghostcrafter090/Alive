...
execute as @e[type=marker,tag=human_is_alive] at @s unless entity @e[tag=is_human,distance=0..1,sort=nearest,limit=1,type=!player] run tag @e[tag=is_human] add gothic_knock_pending
