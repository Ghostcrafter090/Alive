...
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=snowball,tag=gothic_ghost_snowball_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorX *= @e[type=marker,tag=gstools_worker] 200
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=snowball,tag=gothic_ghost_snowball_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorY *= @e[type=marker,tag=gstools_worker] 200
execute as @e[tag=gothic_ghost,tag=ghost_type_poltergeist,sort=random,limit=1] if entity @s[scores={random100=..5}] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=1..30] as @e[type=snowball,tag=gothic_ghost_snowball_thrown,sort=nearest,limit=1] run scoreboard players operation @s vectorZ *= @e[type=marker,tag=gstools_worker] 200
...
execute as @e[type=snowball,tag=gothic_ghost_snowball_thrown,sort=nearest,limit=1,tag=!sound_played] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=0..1] run playsound minecraft:block.stone.break block @a ~ ~ ~ 1 2
execute as @e[type=snowball,tag=gothic_ghost_snowball_thrown,sort=nearest,limit=1,tag=!sound_played] at @s if entity @e[tag=is_alive,sort=nearest,limit=1,distance=0..1] run tag @s add sound_played
