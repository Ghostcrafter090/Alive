...
execute as @a[scores={playerIsSleeping=1..}] if score @s horrorIndex < @s playerIsSleeping unless entity @a[scores={playerIsSleeping=..0}] run time add 5t
...
execute as @a[scores={playerNightmareTic=10..}] if score @s random100 < @s playerNightmareTic run playsound minecraft:gothichorror.hallow.rumble master @a ~ ~ ~ 0.2 0.12
execute as @a[scores={playerNightmareTic=10..}] if score @s random100 < @s playerNightmareTic run effect give @s slowness 30 0 true
execute as @a[scores={playerNightmareTic=20..}] if score @s random100 < @s playerNightmareTic run playsound minecraft:gothichorror.hallow.rumble master @a ~ ~ ~ 0.3 0.14
execute as @a[scores={playerNightmareTic=20..}] if score @s random100 < @s playerNightmareTic run effect give @s slowness 25 1 true
execute as @a[scores={playerNightmareTic=30..}] if score @s random100 < @s playerNightmareTic run playsound minecraft:gothichorror.hallow.rumble master @a ~ ~ ~ 0.4 0.18
execute as @a[scores={playerNightmareTic=30..}] if score @s random100 < @s playerNightmareTic run effect give @s slowness 20 2 true
execute as @a[scores={playerNightmareTic=40..}] if score @s random100 < @s playerNightmareTic run playsound minecraft:gothichorror.hallow.rumble master @a ~ ~ ~ 0.5 0.26
execute as @a[scores={playerNightmareTic=40..}] if score @s random100 < @s playerNightmareTic run effect give @s slowness 15 3 true
execute as @a[scores={playerNightmareTic=50..}] if score @s random100 < @s playerNightmareTic run playsound minecraft:gothichorror.hallow.rumble master @a ~ ~ ~ 0.6 0.42
execute as @a[scores={playerNightmareTic=50..}] if score @s random100 < @s playerNightmareTic run effect give @s slowness 10 4 true
execute as @a[scores={playerNightmareTic=60..}] if score @s random100 < @s playerNightmareTic run playsound minecraft:gothichorror.hallow.rumble master @a ~ ~ ~ 0.7 0.74
