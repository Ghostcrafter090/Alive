...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~ ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~ ~ 0.5 0 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~ ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~ ~ 0.5 0 0.5 0 10 force
