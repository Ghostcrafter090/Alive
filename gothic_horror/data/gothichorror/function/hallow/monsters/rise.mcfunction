...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~ ~ 0.5 0 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~ ~ 0.5 0 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~ ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~1 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~ ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~1 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~1 ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~2 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_setup,tag=!undead_risen] at @s if block ~ ~1 ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~2 ~ 0.5 0.3 0.5 0 10 force
...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,limit=1,sort=random] run function gstools:util/light_level
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..},limit=1,sort=random] run function gstools:util/is_outside
...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..,isOutside=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe if entity @s[name=""] run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..,isOutside=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel unless data entity @s CustomName run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..,isOutside=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel unless data entity @s CustomName run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..,isOutside=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel if entity @s[name=""] run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..,isOutside=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel if entity @s[name=""] run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe unless data entity @s CustomName run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe unless data entity @s CustomName run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe if entity @s[name=""] run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe if entity @s[name=""] run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel unless data entity @s CustomName run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel unless data entity @s CustomName run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel if entity @s[name=""] run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel if entity @s[name=""] run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~ ~ 0.5 0 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~ ~ 0.5 0 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen] at @s if block ~ ~ ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~1 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen] at @s if block ~ ~ ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~1 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen] at @s if block ~ ~1 ~ #minecraft:mineable/pickaxe run particle minecraft:block{"block_state":"minecraft:stone"} ~ ~2 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen] at @s if block ~ ~1 ~ #minecraft:mineable/shovel run particle minecraft:block{"block_state":"minecraft:dirt"} ~ ~2 ~ 0.5 0.3 0.5 0 10 force
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_unrise_setup,tag=!undead_unrisen,scores={undeadRiseTick=1..1}] at @s run playsound minecraft:entity.zombie.attack_wooden_door hostile @a ~ ~1 ~ 2 1
