...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..},limit=1] run function gstools:util/light_level
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={lightLevel=14..},limit=1] run function gstools:util/is_outside
