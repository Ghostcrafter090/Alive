...
execute as @e[type=#minecraft:undead,type=!wither,tag=!undead_setup] at @s facing entity @e[tag=is_alive,sort=nearest,limit=1,distance=0..30] eyes run tp @s ~ ~-2 ~ ~ -90
