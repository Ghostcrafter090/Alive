...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe if entity @s[name="Undead Creature"] run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/pickaxe if entity @s[name="Undead Creature"] run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
...
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel if entity @s[name="Undead Creature"] run data modify entity @s NoAI set value 1b
execute as @e[type=#minecraft:undead,type=!wither,tag=!gothic_ghost,tag=undead_risen,tag=!undead_unrise_setup,scores={isOnFire=1..}] at @s if block ~ ~-1 ~ #minecraft:mineable/shovel if entity @s[name="Undead Creature"] run data merge entity @s {CustomNameVisible:0b,CustomName:"Dinnerbone"}
