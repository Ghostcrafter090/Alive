...
execute as @a[scores={lastBansheeTic=5000..}] if entity @s[scores={bansheeNearbyMonsters=1..}] run scoreboard players operation @s horrorIndex *= @e[type=marker,tag=gstools_worker] n1
execute as @a[scores={lastBansheeTic=5000..}] if entity @s[scores={bansheeNearbyMonsters=1..}] run scoreboard players add @s horrorIndex 100
...
execute as @a[scores={lastBansheeTic=5000..}] run scoreboard players operation @s horrorIndex *= @e[type=marker,tag=gstools_worker] n1
execute as @a[scores={lastBansheeTic=5000..}] run scoreboard players add @s horrorIndex 100
