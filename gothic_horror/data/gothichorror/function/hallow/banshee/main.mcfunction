...
execute as @a[scores={lastBansheeTic=5000..}] if entity @s[scores={bansheeWorkingHealth=1..}] if score @s bansheeWorkingHealth > @s horrorIndex as @e[tag=monster,distance=0..45,sort=random,limit=1] at @s run playsound minecraft:gothichorror.hallow.banshee hostile @a ~ ~ ~ 3
