...
execute as @e[type=text_display,tag=sick_ghost,sort=random,limit=1] if entity @s[scores={lightLevel=8..}] at @s run playsound minecraft:gothichorror.hallow.breath hostile @a ~ ~ ~
execute as @e[type=text_display,tag=sick_ghost,sort=random,limit=1] if entity @s[scores={lightLevel=8..}] at @s run particle large_smoke ~ ~ ~ 0.3 0.3 0.3 0.3 1000 force
