...
execute as @e[type=text_display,tag=sick_ghost,sort=random,limit=1,scores={sickGhostBehaviourMode=0..0}] if entity @s[scores={random1000=..7}] at @s run playsound minecraft:gothichorror.hghost.sick hostile @a ~ ~ ~
...
execute as @e[type=text_display,tag=sick_ghost,scores={sickGhostAnger=1..}] if score @s random1000 < @s sickGhostAnger at @s run playsound minecraft:gothichorror.hghost.sick hostile @a ~ ~ ~
...
execute as @a at @s anchored eyes facing entity @e[type=text_display,tag=sick_ghost,tag=sick_ghost_setup,limit=1,sort=nearest,distance=0..64] eyes anchored feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^-1 if entity @s[distance=..0.07] if score @s EyesPosY >= @s EyesPosX run playsound minecraft:gothichorror.hghost.sick hostile @a ~ ~ ~
...
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=sick_ghost,tag=sick_ghost_setup,limit=1,sort=nearest,distance=..1] run playsound minecraft:gothichorror.hghost.sick hostile @a ~ ~ ~
