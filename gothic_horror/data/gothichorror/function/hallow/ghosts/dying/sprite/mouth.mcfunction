...
execute as @e[type=text_display,tag=dying_ghost,scores={dyingGhostOpenMouthIndex=4..4}] run data modify entity @s text set value '{"text":"p","font":"gothichorror:images"}'
