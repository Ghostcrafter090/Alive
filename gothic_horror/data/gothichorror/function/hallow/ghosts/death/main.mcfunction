...
execute as @e[type=text_display,tag=death_ghost,sort=random,limit=1] if entity @s[scores={random100=..5}] run scoreboard players set @s deathGhostBehaviourMode 1