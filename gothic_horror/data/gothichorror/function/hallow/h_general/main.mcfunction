...
execute if entity @e[tag=gstools_worker,type=marker,scores={timeOfDay=12000..},tag=!after_sunset] as @e[tag=!tile] if score @s random100 < @s horrorIndex at @s run playsound minecraft:gothichorror.rumble hostile @a ~ ~ ~ 9 1
...
execute if entity @e[tag=gstools_worker,type=marker,scores={timeOfDay=18000..},tag=!after_midnight] as @e[tag=!tile] if score @s random100 < @s horrorIndex at @s run playsound minecraft:gothichorror.rumble hostile @a ~ ~ ~ 9 1
