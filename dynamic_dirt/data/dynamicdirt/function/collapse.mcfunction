...
execute if block ~ ~-1 ~ #c:glass_panes run fill ~ ~-1 ~ ~ ~-1 ~ air destroy
execute if block ~ ~-1 ~ #c:glass_blocks run fill ~ ~-1 ~ ~ ~-1 ~ air destroy

execute if block ~ ~ ~ #c:glass_panes run fill ~ ~ ~ ~ ~ ~ air destroy
execute if block ~ ~ ~ #c:glass_blocks run fill ~ ~ ~ ~ ~ ~ air destroy
