...
scoreboard players operation @s horrorIndex /= @e[type=marker,tag=gstools_worker] 41
execute as @r if score @s horrorIndex > @s random1000 at @s unless entity @e[type=text_display,tag=death_ghost,distance=0..30,limit=1] if entity @e[tag=gstools_worker,type=marker,scores={timeOfDay=16000..19000}] run summon text_display ~ ~ ~ {view_range:100f,glow_color_override:1b,width:4f,height:4f,billboard:"center",Tags:["death_ghost"],brightness:{sky:15,block:15},text:'{"text":"a","font":"gothichorror:images"}',background:16711680}
...
execute as @e[type=text_display,tag=death_ghost,sort=random,limit=1] at @s unless entity @a[distance=..200] run kill @s 

execute as @e[type=text_display,tag=death_ghost,sort=random,limit=1] at @s run function gstools:util/light_level
execute as @e[type=text_display,tag=death_ghost,sort=random,limit=1] if entity @s[scores={lightLevel=8..}] at @s run playsound minecraft:gothichorror.hallow.breath hostile @a ~ ~ ~
execute as @e[type=text_display,tag=death_ghost,sort=random,limit=1] if entity @s[scores={lightLevel=8..}] at @s run particle large_smoke ~ ~ ~ 0.3 0.3 0.3 0.3 1000 force
...
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostAnger=1..}] run function gstools:util/random
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostAnger=1..}] run scoreboard players operation @s random1000 *= @e[tag=gstools_worker,type=marker] 1000
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostAnger=1..}] if score @s random1000 < @s deathGhostAnger at @s run playsound minecraft:gothichorror.hghost.death hostile @a ~ ~ ~
...
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run scoreboard players add @s hasLookedAtEyes 100
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run scoreboard players add @s hasLookedAtEyes 100
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run scoreboard players set @s AdrenalineApply 1
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run effect give @s nausea 8 0 true
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run playsound minecraft:gothichorror.hghost.death hostile @a ~ ~ ~
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run tag @s add death_ghost_perform_death_laugh
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] at @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=0..64] run fill ~8 ~8 ~8 ~-8 ~-8 ~-8 air replace light
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run scoreboard players set @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=0..64,tag=!death_ghost_perform_death_laugh] deathGhostBehaviourMode 3
execute as @a at @s positioned ~ ~1 ~ if entity @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=..1] run tag @e[type=text_display,tag=death_ghost,tag=death_ghost_setup,limit=1,sort=nearest,distance=0..64] add death_ghost_perform_death_laugh
