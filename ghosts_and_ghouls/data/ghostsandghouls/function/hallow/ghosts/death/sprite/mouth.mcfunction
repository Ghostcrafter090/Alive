...
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostOpenMouthIndex=4..4}] run data modify entity @s text set value '{"text":"p","font":"gothichorror:images"}'
...
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostOpenMouthIndex=7..7}] run data modify entity @s text set value '{"text":"n","font":"gothichorror:images"}'
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostOpenMouthIndex=8..}] run scoreboard players set @s deathGhostBehaviourMode 0
execute as @e[type=text_display,tag=death_ghost,scores={deathGhostOpenMouthIndex=8..}] run scoreboard players set @s deathGhostOpenMouthIndex 0
