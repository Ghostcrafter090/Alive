...
@Mod("dynamic_monsters")
public class DynamicMonstersMod {
	public static final Logger LOGGER = LogManager.getLogger(DynamicMonstersMod.class);
	public static final String MODID = "dynamic_monsters";

	public DynamicMonstersMod(IEventBus modEventBus) {
