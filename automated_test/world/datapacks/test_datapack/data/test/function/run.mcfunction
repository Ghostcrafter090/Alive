...
scoreboard objectives add test1000 dummy
...
scoreboard players set $test test1000 1000
...
execute if entity @e[tag=gstools_worker,scores={averageTps=15..}] unless score $test automatedTestingFrameworkStarted = $test test1 run scoreboard players set $test testTimeSinceStart 0
