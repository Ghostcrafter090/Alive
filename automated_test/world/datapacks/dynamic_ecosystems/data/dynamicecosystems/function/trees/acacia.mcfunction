...
# Main
execute as @e[tag=gstools_cursor,type=marker] run function dynamicecosystems:trees/acacia_sub/6

execute as @e[type=marker,tag=acacia_tree_worker] run function dynamicecosystems:trees/acacia_sub/9

execute as @e[tag=acacia_tree_worker,type=marker] run function dynamicecosystems:trees/acacia_sub/12
execute as @e[tag=acacia_tree_cursor,type=marker] run scoreboard players add @s treeCursorAliveTime 1

execute as @e[tag=acacia_tree_worker,type=marker] run function dynamicecosystems:trees/acacia_sub/21
...
execute as @e[tag=acacia_tree_worker,type=marker] run function dynamicecosystems:trees/acacia_sub/26
