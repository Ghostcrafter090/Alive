...
# Main
execute as @e[tag=gstools_cursor,type=marker] run function dynamicecosystems:trees/oak_sub/6

execute as @e[type=marker,tag=oak_tree_worker] run function dynamicecosystems:trees/oak_sub/9

execute as @e[tag=oak_tree_worker,type=marker] run function dynamicecosystems:trees/oak_sub/12
execute as @e[tag=oak_tree_cursor,type=marker] run scoreboard players add @s treeCursorAliveTime 10

execute as @e[tag=oak_tree_worker,type=marker] run function dynamicecosystems:trees/oak_sub/21
...
execute as @e[tag=oak_tree_worker,type=marker] run function dynamicecosystems:trees/oak_sub/26
