...
execute if entity @s[scores={diseaseTime=3000..4000,hasImmunityTime=290..291}] run effect give @s nausea 5 2
execute if entity @s[scores={diseaseTime=4000..}] run effect give @s nausea 7 3