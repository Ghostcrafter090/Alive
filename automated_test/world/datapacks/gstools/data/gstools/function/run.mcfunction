...
execute as @e[tag=gstools_worker,type=marker] run function gstools:run_sub/29
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={isSereneSeasonsPresent=1..1}] run function gstools:run_sub/47
