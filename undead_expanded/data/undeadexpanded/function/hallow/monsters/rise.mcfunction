...
function undeadexpanded:hallow/monsters/version_conflict/particle_0
function undeadexpanded:hallow/monsters/version_conflict/particle_1
...
function undeadexpanded:hallow/monsters/version_conflict/particle_2
function undeadexpanded:hallow/monsters/version_conflict/particle_3
