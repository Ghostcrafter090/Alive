...
execute as @a at @s anchored eyes facing entity @e[type=eyesinthedarkness:eyes,limit=1,sort=nearest] eyes anchored feet positioned ^ ^ ^1 rotated as @s positioned ^ ^ ^-1 if entity @s[distance=..0.1] run effect give @s nausea 5 0 true