...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=20..20}] run function lifeanddeath:disease/diseasea
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=20..20}] run function lifeanddeath:disease/diseaseb
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=20..20}] run function lifeanddeath:disease/diseasec
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=20..20}] run function lifeanddeath:disease/diseased
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=19..19,diseaseSectionRegulator=0..0}] run function lifeanddeath:disease/diseasea
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=19..19,diseaseSectionRegulator=0..0}] run function lifeanddeath:disease/diseaseb
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=19..19,diseaseSectionRegulator=1..1}] run function lifeanddeath:disease/diseasec
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=19..19,diseaseSectionRegulator=1..1}] run function lifeanddeath:disease/diseased
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=..18,diseaseSectionRegulator=0..0}] run function lifeanddeath:disease/diseasea
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=..18,diseaseSectionRegulator=1..1}] run function lifeanddeath:disease/diseaseb
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=..18,diseaseSectionRegulator=2..2}] run function lifeanddeath:disease/diseasec
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={averageTps=..18,diseaseSectionRegulator=3..3}] run function lifeanddeath:disease/diseased
...
# Spreaders
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=zombie] run function lifeanddeath:disease/spreaders/zombie
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=drowned] run function lifeanddeath:disease/spreaders/drowned
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=husk] run function lifeanddeath:disease/spreaders/husk
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=wither] run function lifeanddeath:disease/spreaders/wither
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=wither_skull] run function lifeanddeath:disease/spreaders/witherskull
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=wither_skeleton] run function lifeanddeath:disease/spreaders/witherskele
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=zombified_piglin] run function lifeanddeath:disease/spreaders/zombiepig
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=zombie_villager] run function lifeanddeath:disease/spreaders/zombievill
...
# execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] as @e[sort=random,limit=20,type=slime] at @s as @e[distance=0..1,type=!slime,type=!creeper] run effect give @s oozing 400 1
# execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] as @e[sort=random,limit=20,type=slime] at @s as @e[distance=0..1,type=!slime,type=!creeper] run scoreboard players set @s slimeParasiteTime 8000
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] as @e[sort=random,limit=20,type=warden] at @s as @e[tag=!tile,distance=0..1] run effect give @s darkness 400 1
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] as @e[sort=random,limit=20,type=warden] at @s as @e[tag=!tile,distance=0..1] run scoreboard players set @s darkParasiteTime 8000
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] as @a[scores={death=1..}] run scoreboard players set @s hasDiseaseBoolean 0
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableDiseases=1..1}] as @a[scores={death=1..}] run scoreboard players set @s diseaseTime 0
