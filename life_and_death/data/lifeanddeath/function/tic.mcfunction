...
execute as @e[type=zombie,scores={turtleEggCount=1..},limit=1,sort=random] store result entity @s DrownedConversionTime double 0.2 run scoreboard players get @s turtleEggCount
