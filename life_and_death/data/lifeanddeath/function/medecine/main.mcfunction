...
# Main
execute as @e[tag=is_alive,scores={hasDiseaseBoolean=1..2},sort=random,limit=10] unless entity @s[scores={medApply=1..}] run function lifeanddeath:medecine/natural
execute as @e[tag=is_alive,scores={hasDiseaseBoolean=1..2}] run scoreboard players remove @s[scores={medApply=1..}] medApply 1
execute as @e[tag=is_alive,scores={hasDiseaseBoolean=1..2},sort=random,limit=10] unless entity @s[scores={medApply=-1000..}] run scoreboard players set @s medApply 1
