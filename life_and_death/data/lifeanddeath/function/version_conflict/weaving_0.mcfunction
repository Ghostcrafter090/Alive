# Define
scoreboard objectives add spiderParasiteImmunity dummy
...
execute as @e[sort=random,limit=20,scores={spiderParasiteTime=0..}] at @s as @e[distance=0.01..1,scores={spiderParasiteImmunity=..1}] run scoreboard players set @s spiderParasiteTime 8000
execute as @e[sort=random,limit=20,scores={spiderParasiteTime=0..}] at @s as @e[distance=0.01..1,scores={spiderParasiteImmunity=..1}] run scoreboard players set @s spiderParasiteImmunity 32000
execute as @e[sort=random,limit=20,scores={spiderParasiteTime=0..}] run scoreboard players remove @s spiderParasiteTime 1
execute as @e[sort=random,limit=20,scores={spiderParasiteImmunity=0..}] run scoreboard players remove @s spiderParasiteImmunity 1