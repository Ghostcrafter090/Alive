...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={entityInLove=1..}] at @s if entity @e[type=turtle,distance=1..2,scores={entityInLove=1..}] run scoreboard players add @s turtleEggCount 1

execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9800..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=..1}] run data merge entity @s {InLove:100}
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={HasEgg:0b}] run scoreboard players remove @s turtleEggCount 1
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={HasEgg:0b}] if entity @e[type=marker,tag=gstools_worker,scores={enableDebugMessages=1..1}] run say [Alive] Impregnated Turtle...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={HasEgg:0b}] run data merge entity @s {HasEgg:1b}
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={has_egg:0b}] run scoreboard players remove @s turtleEggCount 1
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={has_egg:0b}] if entity @e[type=marker,tag=gstools_worker,scores={enableDebugMessages=1..1}] run say [Alive] Impregnated Turtle...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={has_egg:0b}] run data merge entity @s {HasEgg:1b}
