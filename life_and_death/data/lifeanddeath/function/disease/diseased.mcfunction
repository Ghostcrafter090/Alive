...
# Main
execute if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=wither_skeleton,limit=3,sort=random] run function lifeanddeath:disease/spreaders/witherskele
execute if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=piglin,limit=3,sort=random] run function lifeanddeath:disease/spreaders/zombiepig
execute if entity @a[scores={regulateZombieDiseaseEffects=4..4}] if entity @e[type=zombie_villager,limit=3,sort=random] run function lifeanddeath:disease/spreaders/zombievill
