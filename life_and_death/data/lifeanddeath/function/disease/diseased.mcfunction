...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={ticSecond=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9800..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=..1}] run data merge entity @s {InLove:10}
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={ticSecond=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={HasEgg:0b}] run data merge entity @s {HasEgg:1b}
...
execute unless entity @e[tag=gstools_worker,type=marker,scores={lifeAndDeath_disableBreeding=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={ticSecond=1..1}] as @e[type=turtle,sort=random,limit=10,scores={timeTillHorny=9500..,nearbyHornyEntities=..10,turtleEggCount=1..}] if entity @s[scores={entityInLove=1..}] if entity @s[nbt={has_egg:0b}] run data merge entity @s {HasEgg:1b}