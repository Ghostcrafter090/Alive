...
execute unless entity @e[tag=gstools_worker,type=marker,scores={enhancedSurvivalLoaded=1..1}] as @a[scores={consumptionStrength=1..}] run scoreboard players add @s breathingSoundTic 1
