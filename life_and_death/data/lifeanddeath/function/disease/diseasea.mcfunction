...
execute if entity @e[tag=!functional,scores={hasDiseaseBoolean=1..2,nau_boolean=1..1}] run function lifeanddeath:disease/effecttypes/sound/gag
...
execute if entity @e[tag=!functional,scores={hasDiseaseBoolean=1..2,hung_boolean=1..1}] run function lifeanddeath:disease/effecttypes/sound/vomit
...
execute if entity @e[tag=!functional,scores={hasDiseaseBoolean=1..2,weak_boolean=1..1}] run function lifeanddeath:disease/effecttypes/sound/cough
...
execute if entity @e[tag=!functional,scores={hasDiseaseBoolean=1..2,poi_boolean=1..1}] run function lifeanddeath:disease/effecttypes/sound/weaze
...
execute if entity @e[tag=!functional,scores={hasDiseaseBoolean=1..2,with_boolean=1..1}] run function lifeanddeath:disease/effecttypes/sound/consumption
