execute unless entity @e[type=marker,tag=gstools_worker,scores={desirePaths_enablePermanentPaths=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={blockDecayLoaded=1..1}] run if entity @e[tag=gstools_worker,type=marker,scores={random100=..10}] run fill ~ ~-0.5 ~ ~ ~-1 ~ mud replace farmland
execute if entity @e[type=marker,tag=gstools_worker,scores={desirePaths_enablePermanentPaths=1..1}] if entity @e[type=marker,tag=gstools_worker,scores={blockDecayLoaded=1..1}] run if entity @e[tag=gstools_worker,type=marker,scores={random100=..10}] run fill ~ ~-0.5 ~ ~ ~-1 ~ mud replace grass_path
